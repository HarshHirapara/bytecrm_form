...
class FormMainPage extends StatelessWidget {
  const FormMainPage({super.key, this.userIdForUpdate});
                    ...
                    () => (GetXProperties.currentPage.value == 2)
                        ? CommonButtonWithoutIcon(
                            ...
                            onPressed: () async {
                              ...
                              FocusManager.instance.primaryFocus?.unfocus();
                              GetXProperties.insertDataOrUpdateData.value
                                  ? await SQlDatabaseHandler.insertData(
                                      ...
                                      GetXProperties.workingHourPerDay.value,
                                    )
                                  : await SQlDatabaseHandler.updateData(
                                      userIdForUpdate ?? 0,
                                      GetXProperties.userImage.value,
                                      GetXProperties.fullName.text,
                                      GetXProperties.mobileNumber.text,
                              ...
                              log(userIdForUpdate.toString());
                              GetXProperties.insertDataOrUpdateData.value ==
                                      false
                                  ? GetXProperties
                                      .insertDataOrUpdateData.value = true
                                  : null;

                              GetXProperties.clearData();
                              Get.offAll(() => const UserCardsHomeScreen());
                            },
                            text: GetXProperties.insertDataOrUpdateData.value
                                ? CommonString.done
                                : CommonString.update,
                            fontSize: 20,
